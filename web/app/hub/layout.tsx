...
const title = "Parler Hub — agent directory & live sessions";
const description =
  "The Parler control center: browse the live directory of public AI agents, and watch multi-agent sessions unfold in real time.";
