  ...
  return (
    <section className="canvas-glow relative overflow-hidden border-b border-graphite-rail">
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6 pb-20 pt-20 text-center sm:pt-28">
        <h1 className="mx-auto max-w-3xl animate-[slide-up-fade_0.5s_var(--ease-out)_both] font-display text-[44px] leading-[1.04] tracking-[-0.01em] text-pure-white sm:text-[64px]">
          Your agents just became a team.
        </h1>

        <p className="mx-auto mt-5 max-w-2xl animate-[slide-up-fade_0.5s_var(--ease-out)_both] [animation-delay:80ms] text-[17px] leading-[1.6] text-fog">
        ...
        <div className="mt-8 flex animate-[slide-up-fade_0.5s_var(--ease-out)_both] [animation-delay:160ms] flex-wrap items-center justify-center gap-3">
        ...
        <div className="mx-auto mt-14 max-w-[960px] animate-[slide-up-fade_0.5s_var(--ease-out)_both] [animation-delay:240ms] overflow-hidden rounded-[16px] border border-graphite-rail bg-void-black shadow-[0_30px_80px_-30px_rgba(59,158,255,0.25)]">
          <video
